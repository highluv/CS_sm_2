...
3.1. Создание нового файла: все текущие записи массива сохраняются в новый файл.
3.2. Добавление в существующий файл: новые записи должны быть добавлены в конец файла без изменения уже сохранённых данных.
Имя файла пользователь выбирает самостоятельно.
4. Если файл существует и выбран режим добавления, программа должна корректно дописывать только отсутствующие записи — в конец файла, сохраняя формат.
